...
import "./AvailableApointment.css"

const apointmentgData = [
    {
...
const AvailableApointment = () => {
    return (
        <div className="container available">
            <h3 className="services-head text-center">available appointments on november 2021</h3>
            <div className="row mt-5">
                {
                    apointmentgData.map(data=><AvailableCard data={data}></AvailableCard>)
                }
            </div>
        </div>
    );
